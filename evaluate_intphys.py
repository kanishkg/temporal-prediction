...
def main_worker(gpu, ngpus_per_node, args):
    ...
    intphys_x_o1, intphys_y_o1 = load_intphys(intphys_testfile_o1, projection)
    intphys_x_o2, intphys_y_o2 = load_intphys(intphys_testfile_o2, projection)
    intphys_x_o3, intphys_y_o3 = load_intphys(intphys_testfile_o3, projection)
